...
CREATE USER dkparticipa IDENTIFIED BY pwdparticipa;
GRANT CONNECT, RESOURCE TO dkparticipa;
ALTER USER dkparticipa QUOTA UNLIMITED ON users;

-- Cambiar al esquema del usuario recién creado
ALTER SESSION SET CURRENT_SCHEMA = DKPARTICIPA;
